...
sudo pacman -S wine-staging winetricks --needed --noconfirm
sudo pacman -S giflib lib32-giflib libpng lib32-libpng libldap \
 ...
 lib32-vulkan-icd-loader cups samba dosbox --needed --noconfirm
